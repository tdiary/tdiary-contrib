...
# hb_footer.rb
#
# ’¤Ï’¤Æ’¤Ê’¥Ö’¥Ã’¥¯’¥Þ’¡¼’¥¯ (http://b.hatena.ne.jp/) ’¤Î’¥³’¥á’¥ó’¥È’¤ò’³º’Åö’¥»’¥¯’¥·’¥ç’¥ó’¤Ë’Å½’¤ê’ÉÕ’¤±’¤ëtDiary’¥×’¥é’¥°’¥¤’¥ó
# ’²þ’Â¤’ÈÇrss_recent Version 0.0.5i2’¤È’¶¦’¤Ë’»È’ÍÑ’¤¹’¤ë
#
# Licence: GPL
...
add_section_leave_proc do |date, index|
  ...
  template_head = %Q[<div class="section">\n<h4>’¤³’¤Î’¥»’¥¯’¥·’¥ç’¥ó’¤Ë’ÂÐ’¤¹’¤ë<a href="#{CGI.escapeHTML(hb_url)}">’¤Ï’¤Æ’¥Ö</a></h4>\n<ul class="hb_footer">\n]
